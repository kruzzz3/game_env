...
public class AreaLight extends Light {
    ...
    public AreaLight(int rays, Color color, float x, float y, float width, float height) {
        super(LightManager.getRayHandler(), rays, color, 0, 0);
        setSoftnessLength(0);
        setXray(true);
    ...
    void update () {
        ...
        for (int i = 0; i < rayNum; i++) {
            final float steppedX = i * portionX + posX;
            final float steppedY = i * portionY + posY - height;
            m_index = i;
