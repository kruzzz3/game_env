...
import ch.webk.light.shaders.Gaussian;
import ch.webk.light.shaders.ShadowShader;
import ch.webk.light.shaders.WithoutShadowShader;
...
class LightMap {
	...
	public LightMap(RayHandler rayHandler, int fboWidth, int fboHeight) {
		...
		diffuseShader = shaders.DiffuseShader.createShadowShader();
